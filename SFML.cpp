...
public:
	...
	{
		if (!font.loadFromFile("Waving at Christmas.ttf"))
		{
...
public:
	void drawTextWindows()
	{
		...
		sf::RenderWindow window(sf::VideoMode(width, height), "Text Window", sf::Style::Default);
		sf::Font font;
		if (!font.loadFromFile("Waving at Christmas.ttf"))
		{
...
{	
	...
	sf::RenderWindow window(sf::VideoMode(600, 600), "Menu", sf::Style::Default);
	Menu menu(600, 600);
	while (window.isOpen())
	{
		sf::Event event;
